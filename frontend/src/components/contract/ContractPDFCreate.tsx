...
const ContractPDFCreate: React.FC<{ contractForm: IContractForm }> = ({ contractForm }) => {
  return (
    <>
      <Document>
        <Page size="A4" style={styles.page}>
          ...
          <Text style={styles.introduce}>
            임대인 ( {contractForm.host.hostName} )과 임차인 ( {contractForm.member.name} )은 아래와 같이 임대차 계약을
            체결한다.
          </Text>
          ...
          <View style={styles.section}>
            ...
            <View style={styles.contractContentWrapper}>
              ...
              <Text>
                위 임대주택의 임대차에 한하여 임대인과 임차인은 합의에 의하여 월세 금 {getRent(contractForm.host.rent)}
          ...
          <View style={styles.section}>
            ...
            {getContractJSX({
              person: '임대인',
              name: contractForm.host.hostName,
              registerNo: contractForm.host.registerNo,
              phone: contractForm.host.phone,
              address: contractForm.host.address,
            })}
            {getContractJSX({
              person: '임차인',
...
export default ContractPDFCreate;
