...
public interface ActivityCommandService {
	AddActivityResponseDto addActivity(Long memberNo, MemberRoleType role, Long activityNo,
		AddActivityRequestDto request);

	Long modifyActivity(Long memberNo, MemberRoleType role, Long activityNo,
		ModifyActivityRequestDto request);

	void removeActivity(Long memberNo, MemberRoleType role, Long activityNo);

	SingleMessageSentResponse approveActivity(Long memberNo, MemberRoleType role, Long activityNo);

	Long rejectActivity(Long memberNo, MemberRoleType role, Long activityNo);
